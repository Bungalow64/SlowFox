using ExternalProject.Net3_1.UnitTestMocks.xUnit.Constructors.Sample.Tests.LocalClasses;
using Xunit;

namespace ExternalProject.Net3_1.UnitTestMocks.xUnit.Constructors.Sample.Tests.StructureTests
{
