using ExternalProject.Net7.UnitTestMocks.xUnit.Constructors.Sample.Tests.LocalClasses;
using Xunit;

namespace ExternalProject.Net7.UnitTestMocks.xUnit.Constructors.Sample.Tests.StructureTests;
