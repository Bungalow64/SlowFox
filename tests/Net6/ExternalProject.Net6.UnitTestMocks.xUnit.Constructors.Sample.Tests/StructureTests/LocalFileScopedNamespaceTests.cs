using ExternalProject.Net6.UnitTestMocks.xUnit.Constructors.Sample.Tests.LocalClasses;
using Xunit;

namespace ExternalProject.Net6.UnitTestMocks.xUnit.Constructors.Sample.Tests.StructureTests;
